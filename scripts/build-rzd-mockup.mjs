...
const MOCKUP_DIR = path.resolve("public/cases/rzd/mockup");
const SOURCE_SCREENSHOT = path.resolve("public/cases/rzd-home.png");
...
/**
 * Builds screen-content.png with the RZD screenshot placed in the MacBook screen area.
 */
