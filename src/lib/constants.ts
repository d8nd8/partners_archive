...
export const HEADER_CONTENT = {
  ...
  casesDropdown: [] as readonly { label: string; href: string }[],
  cta: "Узнать больше",
} as const;
  ...
  cards: [
    {
      ...
      description:
        "Мы проектируем, как ИТ будет работать в компании через 1–3 года, а не латаем текущие проблемы.",
      image: "/images/strategic.svg",
    },
    {
      title: "Операционный уровень",
      description: "Разбираем, где бизнес теряет деньги и время прямо сейчас.",
      image: "/images/operational.svg",
    },
    {
      title: "Технологический уровень",
      description: "Мы подбираем и внедряем подходящие инструменты, а не «самые популярные».",
    ...
    },
    {
      ...
      description: "Помогаем бизнесу адаптироваться к цифре, а не просто «оцифровать бардак».",
...
export const EXPERTISE_TAGLINE_CONTENT = {
  ...
  middle: " и ",
  accent2: "даём мнение",
  after: " со стороны благодаря многолетней экспертизе в консалтинговых компаниях, где клиентами были такие компании как Роснефть, BMW, Сбербанк",
} as const;
...
export const PROCESS_CONTENT = {
  ...
  items: [
    ...
    {
      stage: "4 этап",
      title: "Еще один вопрос на ответ",
      description: "",
    },
    {
      stage: "5 этап",
      title: "Вопрос на ответ еще один",
      description: "",
    },
  ],
} as const;
...
export const FOOTER_CONTENT = {
  ...
  contacts: [
    ...
    { label: "+7 (990) 999-99-99", href: "tel:+79909999999" },
  ],
  legal: [
