...
export const EXPERTISE_TAGLINE_CONTENT = {
  ...
  middle: " и ",
  accent2: "даём мнение",
  after: " со стороны благодаря многолетней экспертизе в консалтинговых компаниях, где клиентами были такие компании как РЖД, АльфаСтрахование, Гарант-банк",
} as const;
